...
// Importamos toZonedTime para asegurar la hora de Ecuador
...
export default function JornadasPage() {
  ...
  // Definimos la zona horaria de Ecuador
  ...
  // Función para formatear la fecha forzando la zona horaria de Ecuador
  const formatFechaEcuador = (fechaIso: string) => {
    if (!fechaIso) return '---';
    // Convertimos la fecha ISO a la zona de Ecuador antes de formatear
    const zonedDate = toZonedTime(new Date(fechaIso), timeZone);
    return format(zonedDate, "iii d MMM, HH:mm", { locale: es });
  };
