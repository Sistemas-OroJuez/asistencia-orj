...
export default function EmpleadosPage() {
  ...
  // Estado para el formulario (Incluida la Cédula)
  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto">
      <header className="mb-8 flex justify-between items-center">
        ...
        <button 
          onClick={() => { 
            if (showForm) { setEditandoId(null); resetForm(); }
      ...
      {/* Tabla con Botón de Edición (Lápiz) */}
            ...
            {empleados.map((e) => (
              <tr key={e.id} className="border-b border-slate-100 hover:bg-slate-50 transition-colors">
                <td className="p-4">
                  ...
                  <div className="text-[10px] text-indigo-500 font-bold">CI: {e.cedula || 'N/A'} • ID: {e.user_id_reloj}</div>
                </td>
                <td className="p-4">
